...
readonly SCGW_VERSION=$(tanzu package available list spring-cloud-gateway.tanzu.vmware.com --namespace tap-install --column version -o json |  jq -r '.[0].version')
